...
$route['admin/dashboard/plugins'] = 'Plugins/view_plugins/admin/plugins/plugin_list';
...
$route['dashboard/error404'] = 'Pages/error/error404';
...
$route['admin/dashboard/users/list'] = 'Admin_users_list/admin_users/admin/users/users_list';
$route['admin/dashboard/users/list/edit'] = 'Admin_users_list/admin_users/admin/users/user_list_edit';
