<div class="content">
				...
				<div class="col-md-12">
					<div class="card">
						<h5 class="card-header bg-danger text-white font-weight-bold">
							<i class="material-icons text-white font-weight-bold pull-left">account_box</i><?= $this->lang->line('menu_users_edit'); ?>
						</h5>
						<div class="card-body">
							<p class="card-text">
                              <div class="row">
 <table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      <td class="text-danger font-weight-bold"><input type="text" value="<?= $row->username ;?>" class="form-control"/> </td>
      <td><input type="text" value="<?= $row->email ;?>" class="form-control"/> </td>
      <td><input type="text" value="<?php $created = $row->created_at; echo date("D d M Y",strtotime($created));?>" class="form-control"/></td>
      <?php if ($row->status = 1){
